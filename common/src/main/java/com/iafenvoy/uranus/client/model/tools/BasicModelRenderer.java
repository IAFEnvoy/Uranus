...
public class BasicModelRenderer {
    ...
    public void translateRotate(MatrixStack p_228307_1_) {
        ...
        if (this.rotateAngleZ != 0.0F) {
            p_228307_1_.multiply(RotationAxis.POSITIVE_Z.rotation(this.rotateAngleZ));
        }

        if (this.rotateAngleY != 0.0F) {
            p_228307_1_.multiply(RotationAxis.POSITIVE_Y.rotation(this.rotateAngleY));
        }

        if (this.rotateAngleX != 0.0F) {
            p_228307_1_.multiply(RotationAxis.POSITIVE_X.rotation(this.rotateAngleX));
        }
